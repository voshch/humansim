...
def generate_launch_description():
    node = Node(
        ...
        parameters=[
            {"mode": LaunchConfiguration("mode"),
             ...
             "counterfactual_target_agent_id": ParameterValue(LaunchConfiguration("counterfactual_target_agent_id"), value_type=int),
             "counterfactual_planner": ParameterValue(LaunchConfiguration("counterfactual_planner"), value_type=str),
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument("counterfactual_target_agent_id", default_value="0", description="positive runtime ID of one flow-spawned human whose planner is overridden; 0 disables the intervention"),
        DeclareLaunchArgument("counterfactual_planner", default_value="", description="planner assigned to counterfactual_target_agent_id; empty disables the intervention"),
